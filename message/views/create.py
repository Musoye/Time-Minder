...
def create_accout():
    ...
    msg = Message('Creation of Account', sender="Time Master oyebamijimustapha44@gmail.com", recipients=[email], bcc=['oyebamijimustapha44@gmail.com'])
...
def change_password():
    ...
    name = data.get('first_name')
    email = data.get('email')
    msg = Message('Changing of Password', sender='Time Master oyebamijimustapha44@gmail.com', recipients=[email], bcc=['oyebamijimustapha44@gmail.com'])
